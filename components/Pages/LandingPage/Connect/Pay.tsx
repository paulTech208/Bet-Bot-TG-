...
const Pay = () => {
  ...
  return (
    <div className="w-full h-[150px] p-3 bg-white rounded-[15px] flex justify-between items-center">
      <div className="flex flex-col text-white_1 font-fixedsys">
        <p className="text-xs text-black_3">You pay</p>
        <input
          type="text"
          value={payAmount}
          className="w-[100px] md:w-[150px] !outline-none !border-none !ring-0 focus:outline-none focus:border-none focus:ring-0
      ...
      <button
        type="button"
        className="bg-green_3 px-2 md:px-4 py-1 rounded-full text-black font-bold
