  ...
  <Container>
    <FadeInWhenVisible className="flex flex-col justify-center items-center pt-[100px]">
      ...
      <div className="w-full pt-5 pb-1 mx-auto">
        <p className="font-seoge text-green font-bold text-3xl md:text-6xl text-center leading-[130%]">
          Genesis $Bitbot Allocation
        </p>
        <p
          className="font-seoge text-black_3 font-300 text-sx md:text-xl text-center 
