  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        gradient_purple: "linear-gradient(90deg, #c160b5 0.1%, #e06f60 100.1%, #f2c045 0.1%)",
      },
      backgroundColor: {
    ...
    animation: {
      flow: '152.573s linear 0s infinite normal none running templates-partner-moving-right'
    }
  },
  variants: {
    extend: {
